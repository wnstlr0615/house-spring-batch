...
// 2. LAWD_CD 법정동 코드 10자리 중 앞 5 자리 구지역코드 guLawdCd  예) 41135
// 3. DEAL_YMD - 거래가 발생한 년월 예 202007
@Slf4j
@Component
public class ApartmentApiResource {
    ...
    public Resource getResource(final String lawdCd, final YearMonth yearMonth)  {
